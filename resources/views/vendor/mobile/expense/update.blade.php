...
<div class="page-content-wrapper py-3">
      ...
      <div class="container">
            <div class="card">
                  <div class="card-body">
                        <form id="mobileExpenseUpdate" method="POST" enctype="multipart/form-data">
                              @csrf
                              <div class="form-group">
                                    <label class="form-label" for="name">{{__('expense.name')}} *</label>
                                    <input class="form-control" id="name" type="text" name="name" value="{{ old('name',$expense->name) }}" id="name" required>
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="amount" value="{{ old('amount',number_format($expense->amount)) }}" id="amount">
                              </div>
                              <div class="form-group">
                                    ...
                                    <select class="choices form-select" name="shift_register" id="shift_register">
                                          @if($expense->shift_register == 'yes')
                                          <option value="yes">Iya</option>
                                          <option value="no">Bukan</option>
                                          @elseif($expense->shift_register == 'no')
                                          <option value="no">Bukan</option>
                                          <option value="yes">Iya</option>
                                          @endif
                                    </select>
                              ...
                              <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="detail" name="detail" cols="3" rows="5" placeholder="Masukkan Detail atau Catatan...">{{ old('detail',$expense->detail) }}</textarea>
                              </div>
                              ...
                              <button class="btn btn-primary w-100 d-flex align-items-center justify-content-center" type="submit">Edit Pengeluaran </button>
                        </form>
                  </div>
            </div>
      </div>
