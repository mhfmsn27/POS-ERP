...
<div class="auth-page-wrapper">
    <div class="auth-split-container auth-split-container-wide">
        ...
        <div class="auth-form-side">
            ...
            <!-- Register Form -->
            <form class="validate-form row g-3" method="POST" action="{{ route('auth.register.create') }}">
                @csrf
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="form-group mb-0">
                        ...
                        <div class="position-relative">
                            <input class="form-control auth-input-with-icon" type="password" id="regPassword" name="password" required placeholder="Minimal 8 karakter">
                            <span class="auth-field-icon">
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="form-group mb-0">
                        ...
                        <div class="position-relative">
                            <input class="form-control auth-input-with-icon" type="password" id="regPasswordConfirm" name="password_confirmation" required placeholder="Ulangi kata sandi">
                            <span class="auth-field-icon">
