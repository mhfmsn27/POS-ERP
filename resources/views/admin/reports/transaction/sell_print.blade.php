                                ...
                                <div class="table-responsive">
                                    <table class="table" style="font-size: 10px;">
                                        <tbody>
                                            <tr>
                                                <th>#</th>
                                                <th class="text-center">{{__('general.date')}}</th>
                                                <th class="text-center">{{__('general.ref_no')}}</th>
                                                <th class="text-center">{{__('general.payment_total')}}</th>
                                                <th class="text-center">{{__('general.payment_method')}}</th>
                                                <th class="text-center">{{__('general.payment_note')}}</th>
                                            </tr>
                                            @php
