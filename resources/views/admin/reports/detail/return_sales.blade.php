                              ...
                              <div class="accordion" id="accordionSearching">
                                    <div class="accordion-item rounded">
                                          ...
                                          <div id="searchdata" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-parent="#accordionSearching">
                                                <form action="{{route('export.detail.returnsell')}}" target="_blank" method="GET" class="accordion-body">
                                                      <div class="row">
...
<script>
      $(document).ready(function() {
            const sell_table = $('#sellContent').DataTable({
                  ...
                  ajax: {
                        "url": domain + domainpath + '/pos-admin/report/detail/return-sales',
                        "data": function(d) {
                  ...
                  footerCallback: function(row, data, start, end, display) {
                        ...
                        $(api.column(2).footer()).html(formatRupiah(returntotal.toString()));
                        $(api.column(3).footer()).html(formatRupiah(satuantotal.toString()));
