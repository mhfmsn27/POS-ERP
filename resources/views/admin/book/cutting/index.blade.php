                            ...
                            <table class="table table-striped" id="table-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @can("update_cutting")
                                            <a href="{{route('cutting.update',$d->id)}}" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
                                            @endcan
                                            @can("delete_cutting")
                                            <a href="{{route('cutting.delete',$d->id)}}" class="btn btn-sm btn-danger deletebutton"><i class="fa fa-trash"></i></a>
                                            @endcan
                                        </td>
                                    </tr>
                                    @endforeach
