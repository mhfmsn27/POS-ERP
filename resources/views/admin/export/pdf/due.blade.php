<table class="table table-striped">
    <thead>
        ...
        <tr>
            ...
            <th style="width: 170px; text-align:center; ">{{__('customer.name')}}</th>
            <th style="width: 150px; text-align:center; ">{{__('hrm.amount_total')}}</th>
            <th style="width: 150px; text-align:center; ">{{__('general.pay_amount')}}</th>
