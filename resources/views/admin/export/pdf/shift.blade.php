<table class="table table-striped">
    <thead>
        ...
        <tr>
            <th style="width: 100px; text-align:center; height: 60px;">Tanggal</th>
            ...
            <th style="width: 110px; text-align:center; ">Open Amount</th>
            <th style="width: 150px; text-align:center; ">Close Amount</th>
            <th style="width: 150px; text-align:center; ">Other Amount</th>
    ...
    <tbody>
        ...
        @foreach ($data as $d)
            <tr>
                <td style="text-align:left; height: 35px;"> {{ dt($d->created_at) }} </td>
