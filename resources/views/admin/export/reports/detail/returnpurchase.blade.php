<table class="table table-striped">
      <thead>
            <tr>
                  <th colspan="8" style="background-color: yellow; text-align:center; font-size: 30px; height: 50px; font-weight:50;"><b>Laporan Return Pembelian</b></th>
            </tr>
            <tr>
      ...
      <tbody>
            ...
            <tr>
                  ...
                  <td style="text-align:left;">
                        ...
                        $variation = $d->purchase->variation->name ?? '';
                  ...
                  <td style="text-align:left;"> {{ $d->transaction->supplier->name ?? '' }} </td>
                  <td style="text-align:right;"> {{ number_format($d->return_qty) }} </td>
                  <td style="text-align:right;"> {{ number_format($d->purchase->purchase_price ?? 0) }} </td>
      ...
      <tfoot>
            <tr style="background-color: #5cb85c; border: 1px solid white" class="text-white">
                  <th colspan="7" style="height: 30px; font-size:100px; background-color:#5cb85c; text-align:center;">Jumlah Total</th>
