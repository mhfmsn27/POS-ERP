<table class="table table-striped">
      <thead>
            <tr>
                  <th colspan="10" style="background-color: yellow; text-align:center; font-size: 30px; height: 50px; font-weight:50;"><b>Laporan Penjualan</b></th>
            </tr>
            <tr>
                  <th style="width: 100px; text-align:center; height: 40px;">No Ref</th>
                  <th style="width: 100px; text-align:center; ">Tanggal</th>
                  <th style="width: 150px; text-align:center; ">Toko</th>
                  <th style="width: 150px; text-align:center; ">Produk</th>
                  <th style="width: 150px; text-align:center; ">Pelanggan</th>
                  <th style="width: 100px; text-align:center; ">Qty Di Jual</th>
                  ...
                  <th style="width: 100px; text-align:center; ">Profit</th>
            </tr>
            <tr>
      ...
      <tbody>
            ...
            <tr>
                  ...
                  <td style="text-align:left;"> {{ number_format($d->qty) }} </td>
                  ...
                  <td style="text-align:right;"> {{ number_format($d->profit_sales) }} </td>
            </tr>
            @endforeach
      </tbody>
      <tfoot>
            <tr style="background-color: #5cb85c; border: 1px solid white" class="text-white">
                  ...
                  <th style="text-align:right;"><b>{{ number_format($income) }}</b></th>
            </tr>
      </tfoot>
</table>