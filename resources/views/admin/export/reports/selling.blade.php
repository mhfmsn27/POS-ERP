<table class="table table-striped">
    <thead>
        ...
        <tr>
            ...
            <th style="width: 150px; text-align:center"><b>{{__('general.store')}}</b></th>
            <th style="width: 150px; text-align:center"><b>{{__('customer.name')}}</b></th>
            <th style="width: 100px; text-align:center"><b>{{__('general.payment_status')}}</b></th>
            <th style="width: 150px; text-align:center"><b>{{__('report.product_sell')}}</b></th>
            <th style="width: 100px; text-align:center">{{__('report.qty_sell')}}</th>
            ...
            <th style="width: 100px; text-align:center">{{__('general.sell_due_amount')}}</th>
            <th style="width: 100px; text-align:center">{{__('report.profit_amount')}}</th> 
            <th style="width: 100px; text-align:center">{{__('report.createdby')}}</th>
        </tr>
        <tr>
    ...
    <tfoot>
        <tr style="background-color: #5cb85c; border: 1px solid white" class="text-white">
            <th colspan="7" style="height: 30px; font-size:100px; background-color:#5cb85c; text-align:center; color:white"><b>{{__('report.total_income')}} : {{ number_format($jumlahProfit) }}</b></th>
