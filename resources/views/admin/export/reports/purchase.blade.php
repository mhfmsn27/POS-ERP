<table class="table table-striped">
    <thead>
        ...
        <tr>
            ...
            <th style="width: 100px; text-align:center">{{__("general.ref_no")}}</th>
            <th style="width: 150px; text-align:center">{{__('general.store')}}</th>
            <th style="width: 150px; text-align:center">{{__('supplier.name')}}</th>
            <th style="width: 100px; text-align:center">{{__('report.product_purchase')}}</th>
            <th style="width: 100px; text-align:center">{{__('report.qty_purchase')}}</th>
            <th style="width: 100px; text-align:center">{{__('purchase.received_status')}}</th>
            <th style="width: 100px; text-align:center">{{__('general.payment_status')}}</th>
    ...
    <tbody>
        ...
        <tr class="purchase_order">
            ...
            <td style="text-align:right;"> {{ number_format($d->due_total_po ?? $d->final_total) }} </td>
        </tr>
        @endforeach
    </tbody>
    <tfoot>
        <tr style="background-color: #5cb85c; border: 1px solid white" class="text-white">
            <th colspan="8" style="height: 30px; font-size:100px; background-color:#5cb85c; text-align:center;"><b>{{__('general.total')}}</b> </th>
