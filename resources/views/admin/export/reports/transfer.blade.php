<table class="table table-striped">
    <thead>
        ...
        <tr>
            ...
            <th style="width: 150px; text-align:center; height: 40px;">{{__('transfer.from')}}</th>
            <th style="width: 150px; text-align:center; height: 40px;">{{__('transfer.to')}}</th>
            <th style="width: 100px; text-align:center; height: 40px;">{{__('transfer.status')}}</th>
            <th style="width: 100px; text-align:center; height: 40px;">{{__('purchase.shipping_cost')}}</th>
    ...
    <tfoot>
        <tr style="background-color: #5cb85c; border: 1px solid white" class="text-white">
            <th colspan="6" style="height: 30px; font-size:100px; background-color:#5cb85c; text-align:center;">{{__('general.total')}}</th>
