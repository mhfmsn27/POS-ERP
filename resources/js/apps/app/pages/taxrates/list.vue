        ...
        <div class="card custom-card">
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    ...
                    >
                        <Column field="supplier.name" header="Pemasok"></Column>
                        <Column field="ref_no" header="No Pembelian"></Column>
        ...
        async getData(page = 1) {
            ...
            try {
                const response = await ApiData.get(
                    `app/taxs?limit=${this.limit}&page=${this.page}&name=${this.filter.name}&start_date=${this.filter.date.start}&end_date=${this.filter.date.end}&sub_type=tax_input&status_payment=${this.filter.payment_status}&status=${this.filter.status}`
                );
