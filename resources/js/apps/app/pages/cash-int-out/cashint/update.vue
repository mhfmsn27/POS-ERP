<template>
    <div class="col-12">
        <Form @submit="createReceivedPurchase()" ref="ValidationTransactions">
                ...
                <div class="card-body">
                    <div class="row p-3">
                        ...
                        <div class="col-lg-4">
                            ...
                            >
                                <Multiselect
                                    ...
                                    placeholder="Pilih Metode Penerimaan"
                        ...
                        >
                            ...
                            >
                                <i class="fa fa-plus-circle"></i> Tambah Daftar
                                Pendapatan
                            </button>
                        </div>
                        <div class="col-12 mt-3">
                            <div class="table-responsive">
                                <table class="table text-nowrap table-bordered">
                                    <thead>
                                        <tr>
                                            <th v-if="with_accountant">Akun</th>
                                            <th>Nama Akun</th>
                                            <th>Nilai</th>
                                            <th>Aksi</th>
                                        </tr>
        ...
        async getDetails() {
            try {
                const response = await ApiData.get(
                    `app/expenses/detail/${this.$route.params.id}`
                );
                var data = response.data;
        ...
        createReceivedPurchase() {
            this.$refs.ValidationTransactions.validate().then((success) => {
                if (!success) {
                    ...
                    NProgress.set(0.1);
                    ApiData.post(
                        "app/expenses/update/" + this.$route.params.id,
                        this.transaction
                    )
                        .then((response) => {
