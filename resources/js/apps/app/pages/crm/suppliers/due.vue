    ...
    <div class="row">
        ...
        >
            <Form
                ...
                ref="createValidationTransaction"
            >
                <div class="row p-3">
        ...
        <Dialog
            ...
            class="filter-data"
            :header="editmode ? 'Edit Pembayaran' : 'Tambah Pembayaran Faktur'"
            :style="{ width: '35rem' }"
            :breakpoints="{ '1199px': '75vw', '575px': '90vw' }"
        >
            ...
            <template #footer>
                ...
                <button
                    ...
                    class="btn btn-outline-info btn-wave waves-effect waves-light"
                >
                    {{ editmode ? "Simpan Perubahan" : "Tambahkan Pembayaran" }}
                </button>
            </template>
        </Dialog>
        <!-- End payment -->
            ...
            <div class="row p-3">
                <div class="col-12 table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <tr
                                v-for="(detail, index) in payments"
                                :key="index"
                            >
                                <td>
                                    {{ detail.date }}
        ...
        >
            <div class="card-body ps-5 pe-5 pt-2 pb-5 rectangle3">
                ...
                <p class="mb-4 text-muted op-7 fw-normal text-center">
                    Silahkan upload file xlsx di bawah ini untuk melakukan
                    proses import data Saldo
                </p>
                <div class="row gy-3">
                    <div
                        class="col-xl-12 d-flex justify-content-center mt-3 mb-3"
                    >
                        <FileUpload
                            mode="basic"
...
export default {
    ...
    methods: {
        ...
        importData() {
            ...
            ApiData.post(
                "app/crm/suppliers/import/due/" + this.$route.params.id,
                this.data
            )
                .then((response) => {
        ...
        async downloadExample() {
            ...
            try {
                const response = await ApiData.get(
                    `app/crm/suppliers/import/download-due`,
                    {
                        responseType: "blob",
                        headers: {
                ...
                link.setAttribute(
                    "download",
                    "sample_export_due_supplier.xlsx"
                );
        ...
        async getData(page = 1) {
            ...
            try {
                const response = await ApiData.get(
                    `app/transactions/transaction-due?limit=${this.limit}&page=${this.page}&name=${this.filter.name}&supplier=${this.$route.params.id}&type=hutang`
                );
