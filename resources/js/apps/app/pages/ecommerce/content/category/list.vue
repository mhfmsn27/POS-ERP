        ...
        <div class="card card-block card-stretch card-height">
            <div class="card-header d-flex justify-content-between p-3">
                ...
                <a
                    ...
                    class="btn btn-blue"
                >
                    <i class="fe fe-plus-circle me-2"></i> Tambah Kategori
                </a>
            </div>
            <div class="card-body p-0">
                <div class="table-responsive">
                    ...
                    >
                        ...
                        <Column field="blogs" header="Total Blog"></Column>
        ...
        async getData(page = 1) {
            ...
            try {
                const response = await ApiData.get(
                    `app/ecommerce/blogs/categories?limit=${this.limit}&page=${this.page}&name=${this.filter.name}`
                );
        ...
        removeData(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    NProgress.set(0.1);
                    ApiData.delete(
                        "app/ecommerce/blogs/categories/delete/" + id
                    )
                        .then((response) => {
