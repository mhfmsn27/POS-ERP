    ...
    <div class="col-lg-9 col-sm-12">
        <div class="card card-block card-stretch card-height">
            <div class="card-header d-flex justify-content-between p-3">
                <div>
                    <label class="control-label">Judul blog</label>
                ...
                <a
                    ...
                    class="btn btn-blue"
                >
                    <i class="fe fe-plus-circle me-2"></i> Tambah Article
                </a>
            </div>
            <div class="card-body p-0">
                <div class="table-responsive">
                    ...
                    >
                        ...
                        <Column field="category" header="Kategroi"></Column>
                        ...
                        <Column header="Aksi">
                            <template #body="{ data }">
                                <div class="btn-list">
                                    ...
                                    >
                                        <i class="fe fe-edit me-2"></i>Edit Blog
                                    </a>
        ...
        async getData(page = 1) {
            ...
            try {
                const response = await ApiData.get(
                    `app/ecommerce/blogs/article?limit=${this.limit}&page=${this.page}&name=${this.filter.name}`
                );
        ...
        removeData(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    NProgress.start();
                    NProgress.set(0.1);
                    ApiData.delete("app/ecommerce/blogs/article/delete/" + id)
                        .then((response) => {
