    ...
    <div class="col-lg-9 col-sm-12">
        <div class="card card-block card-stretch card-height">
            <div class="card-header d-flex justify-content-between p-3">
                <div>
                    <label class="control-label">Nama featured</label>
                ...
                <a
                    ...
                    class="btn btn-blue"
                >
                    <i class="fe fe-plus-circle me-2"></i> Tambah featured
                </a>
            </div>
        ...
        async getData(page = 1) {
            ...
            try {
                const response = await ApiData.get(
                    `app/ecommerce/media-content/featureds?limit=${this.limit}&page=${this.page}&name=${this.filter.name}`
                );
        ...
        removeData(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    NProgress.set(0.1);
                    ApiData.delete(
                        "app/ecommerce/media-content/featureds/delete/" + id
                    )
                        .then((response) => {
