    ...
    <div class="col-lg-9 col-sm-12">
        <div class="card card-block card-stretch card-height">
            <div class="card-header d-flex justify-content-between">
                <h4 class="card-title">Pengaturan Akun Default Produk</h4>
            </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-sm-12 mt-3">
                            ...
                            <Multiselect
                                v-model="form.product_retur_sale"
                                :options="accounts"
                                :multiple="false"
                                :close-on-select="true"
                                :clear-on-select="true"
                        ...
                        <div class="col-lg-6 col-sm-12 mt-3">
                            ...
                            <Multiselect
                                v-model="form.product_discount_sale"
                                :options="accounts"
                                :multiple="false"
                                :close-on-select="true"
                                :clear-on-select="true"
                        ...
                        <div class="col-lg-6 col-sm-12 mt-3">
                            ...
                            <Multiselect
                                v-model="form.product_retur_purchase"
                                :options="accounts"
                                :multiple="false"
                                :close-on-select="true"
                                :clear-on-select="true"
...
export default {
    ...
    methods: {
        ...
        updateData() {
            ApiData.post("app/settings/account/product", this.form)
                .then((response) => {
