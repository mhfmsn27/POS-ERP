...
export default {
    ...
    methods: {
        ...
        RemoveItem(id, index) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    NProgress.set(0.1);
                    ApiData.delete(
                        "app/transactions/sales/shipping/delete-item/" + id
                    )
                        .then((response) => {
                    ...
                    if (filteredLowPrice.length > 0) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                NProgress.set(0.1);
                                ApiData.post(
                                    "app/transactions/sales/shipping/update/" +
        ...
        saveAndPrint() {
            this.updateShippingProducts("print");
        },
