<template>
    <Form ref="ValidationForOtherInformation" class="col-12">
        <div class="row">
                        ...
                        <div class="p-4">
                            <div class="row gx-5">
                                ...
                                <div class="col-lg-12 mt-4">
                                    <Fieldset
                                        legend="Informasi Pajak & Diskon"
                                        :toggleable="show.general"
                                    >
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="row">
            ...
            <div class="col-1">
                ...
                <button
                    v-if="transaction.payment_information.payment.due_total"
                    type="button"
                    @click="addToPayment()"
                    :disabled="loader.submit"
    ...
    <Dialog
        ...
        class="filter-data"
        header="simpan dan Bayar Penjualan"
        :style="{ width: '35rem' }"
        :breakpoints="{ '1199px': '75vw', '575px': '90vw' }"
    >
        <div class="row p-3">
...
export default {
    ...
    methods: {
        ...
        async getDetails() {
            try {
                const response = await ApiData.get(
                    `app/transactions/sales/edit/${this.$route.params.id}`
                );
                var data = response.data;
                this.transaction.qty_sell = data.qty_sell;
                ...
                this.tax_option.default =
                    data.general_information.customer.default;
                this.tax_option.customer_type =
                    data.general_information.customer.type;
                this.tax_option.with_tax =
                    data.general_information.customer.tax_option;
            ...
            if (item_id != null) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ApiData.delete(
                            "app/transactions/sales/delete-item/" + item_id
                        )
                            .then((response) => {
