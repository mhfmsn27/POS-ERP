            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    ...
                    >
                        ...
                        <Column field="from.name" header="Dari Gudang"></Column>
                        <Column field="to.name" header="Ke Gudang"></Column>
                        <Column
                            field="created.name"
                            header="Ditambahkan"
                        ></Column>
                        ...
                        <Column field="action" header="Aksi">
                            <template #body="{ data }">
                                <a
                                    ...
                                    "
                                    v-tooltip.left="'Detail Transfer Gudang'"
        ...
        async getData(page = 1) {
            ...
            try {
                const response = await ApiData.get(
                    `app/transactions/transfer-warehouse?limit=${this.limit}&page=${this.page}&ref=${this.filter.name}&start_date=${this.filter.date.start}&end_date=${this.filter.date.end}&createdby=${this.filter.user.id}&supplier=${this.filter.supplier.id}&status=${this.filter.status}`
                );
