            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <DataTable
                        ...
                        dataKey="id"
                    >
                        <Column field="name" header="Nama Notifikasi"></Column>
        ...
        async getData(page = 1) {
            ...
            try {
                const response = await ApiData.get(
                    `app/settings/templates?limit=${this.limit}&page=${this.page}&name=${this.filter.name}`
                );
        ...
        removeData(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    NProgress.start();
                    NProgress.set(0.1);
                    ApiData.delete("app/settings/templates/delete/" + id)
                        .then((response) => {
