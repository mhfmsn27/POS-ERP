<template>
    <Form @submit="createRma()" ref="ValidationTransactions" class="col-12">
        <div class="row">
...
export default {
    ...
    methods: {
        changeCustomer(e) {
            this.transaction.customer_name = e.name;
            this.transaction.phone = e.phone;
        },
        ...
        createRma(type = "") {
            this.$refs.ValidationTransactions.validate().then((success) => {
                if (!success) {
                    ...
                    NProgress.start();
                    NProgress.set(0.1);
                    ApiData.post("app/transactions/rma/store", this.transaction)
                        .then((response) => {
