            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    ...
                    >
                        ...
                        <Column field="faktur" header="Nomor Ref"></Column>
                        ...
                        <Column header="Nilai Komisi">
                            <template #body="{ data }">
                                {{ formatNumber(data.commission_total) }}
                            </template>
                        </Column>
                        ...
                        <Column field="created" header="Ditambahkan"></Column>
                    </DataTable>
                </div>
            </div>
        </div>
        ...
        async getData(page = 1) {
            ...
            try {
                const response = await ApiData.get(
                    `app/hrm/commission?limit=${this.limit}&page=${this.page}&ref=${this.filter.name}&start_date=${this.filter.date.start}&end_date=${this.filter.date.end}&createdby=${this.filter.user.id}&status=${this.filter.status}`
                );
