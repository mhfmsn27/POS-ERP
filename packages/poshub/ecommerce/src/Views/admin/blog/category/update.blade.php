        ...
        <div class="row">
            ...
            <div class="col-md-12 col-12">
                <div class="card card-block card-stretch card-height">
                    ...
                    <div class="card-body">
                        <form id="uBlog" method="POST" enctype="multipart/form-data" class="form form-horizontal">
                            @csrf
                            <div class="form-body">
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8 form-group">
                                        <input type="hidden" id="idBlog" value="{{$category->id}}">
                                        <input type="text" class="form-control" name="name" id="name" value="{{$category->name}}" required placeholder="Masukkan Title">
                                    </div>
                                </div>
