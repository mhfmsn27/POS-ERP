            ...
            <div class="row">
                  ...
                  <div class="col-md-12 col-12">
                        <div class="card card-block card-stretch card-height">
                              ...
                              <div class="card-body">
                                    <form action="{{route('ecommerce.blogs.edit',$blog->slug)}}" method="POST" enctype="multipart/form-data" class="form form-horizontal">
                                          @csrf
                                          <div class="form-body">
                                                <div class="row mb-3">
                                                      <div class="col-md-4">
                                                      ...
                                                      <div class="col-md-8 form-group">
                                                            <input type="text" class="form-control" name="title" id="title" value="{{$blog->title}}" required placeholder="Masukkan Title">
                                                      </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                      ...
                                                      <div class="col-md-8 form-group">
                                                            <textarea id="summernote" style="height: 350px" name="description">{{ old('description',$blog->description) }}</textarea>
                                                      </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                      ...
                                                      <div class="col-md-8 form-group">
                                                            <input class="dropify" type="file" id="image" name="thumbnail" data-default-file="{{asset($blog->thumbnail)}}">
                                                      </div>
                                                </div>
