                            ...
                            <table class="table table-striped" id="table-1">
                                ...
                                <tbody>
                                    ...
                                    <tr class="data-product">
                                        ...
                                        <td>
                                            <a href="{{ route('ecommerce.content.category.delete',$c->id) }}" class="btn btn-sm btn-danger deletebutton"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
...
<div class="modal fade" id="addCategory" tabindex="-1" role="dialog" aria-labelledby="add-category" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-full modal-lg " role="document">
        <form method="POST" action="{{route('ecommerce.content.category.store')}}" class="modal-content">
            @csrf
            <div class="modal-header header-modal ">
                <h5 class="modal-title" id="">Opsi Kategori</h5>
