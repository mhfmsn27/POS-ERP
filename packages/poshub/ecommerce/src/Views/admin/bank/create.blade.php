        ...
        <div class="row">
            ...
            <div class="col-md-12 col-12">
                <div class="card card-block card-stretch card-height">
                    ...
                    <div class="card-body">
                        <form action="{{route('ecommerce.bank.store')}}" method="POST" enctype="multipart/form-data" class="form form-horizontal">
                            @csrf
                            <div class="form-body">
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8 form-group">
                                        <input type="text" class="form-control" name="bank_name" required placeholder="Masukkan Nama Bank">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8 form-group">
                                        <input type="text" class="form-control" name="no_rek" required placeholder="Masukkan Nomor Rekening">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8 form-group">
                                        <input type="text" class="form-control" name="an" required placeholder="Atas Nama">
                                    </div>
                                </div>
