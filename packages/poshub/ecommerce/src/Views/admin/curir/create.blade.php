        ...
        <div class="row">
            ...
            <div class="col-md-12 col-12">
                <div class="card card-block card-stretch card-height">
                    ...
                    <div class="card-body">
                        <form id="cKurir" method="POST" enctype="multipart/form-data" class="form form-horizontal">
                            @csrf
                            <div class="form-body">
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8 form-group">
                                        <input type="text" class="form-control" name="name" id="name" required placeholder="Masukkan Nama">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8 form-group">
                                        <input type="text" class="form-control" required name="code" id="code" placeholder="Masukkan Kode">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8 form-group">
                                        <input class="dropify" type="file" id="image" name="logo" data-default-file="">
                                    </div>
                                </div>
