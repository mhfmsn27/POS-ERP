...
class Permission extends Model implements PermissionContract
{
    ...
    {
        return $this->belongsTo(ModuleFeature::class, 'module_id');
    }
    ...
    public function role_permission_access($role)
    {
        $roleHas = DB::table("role_has_permissions")->where("role_id", $role)
