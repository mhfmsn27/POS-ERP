...
class ProcessSalesRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [ 
            ...
            'general_information.customer.id'   => 'required',
    ...
    {
        return [
            'payment_information.method.id.required_if'     => 'Metode Pembayaran harus di isi',
            'general_information.customer.id.required'      => 'Informasi customer Harus Diisi',
